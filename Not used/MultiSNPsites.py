...
# MultiSNPsites.py, Version 1.5

# This script converts multi-FASTA alignments (.mfa) files structured as pairs of aligned sequences into a single VCF file
# using the external software application SNP-sites. Since the data from the 1000 GP is divided into chromosomes, 
...
# UPDATES: This version removes gaps from the human sequence.
